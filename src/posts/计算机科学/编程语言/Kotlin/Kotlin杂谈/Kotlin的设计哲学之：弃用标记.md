...
你说这群 `JetBrains` 工程师是不是事多？多大点事——我就注释了几行代码，还专门标个黄杠杠警告我。说实话，我一开始也不理解。但当我的代码越写越多、项目越经越多，当我能写出高内聚低耦合的结构、能写出易于修改和维护的设计时，我终于理解了这群`Jetbrains`的工程师。

是的，他们用心良苦，为了防止你们写出不规范的代码，他们甚至想要手把手教你。**被注释掉的代码**，刚写下的时候没什么大不了；但项目变大、人换了又换，后来者看到这段代码，它就成了一道迷题：这是准备以后解封继续用的？还是可以直接删掉的？没人知道。**被注释的代码不会说话，但它留下的困惑，足以让维护者抓狂。**
