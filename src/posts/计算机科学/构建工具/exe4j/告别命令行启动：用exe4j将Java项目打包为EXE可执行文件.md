...
![ScreenShot_2026-06-28_135941_783](./assets/ScreenShot_2026-06-28_135941_783.png)



左侧选择 `Artifacts` → 点击 `+` → `JAR` → `From modules with dependencies`

![ScreenShot_2026-06-28_140159_584](./assets/ScreenShot_2026-06-28_140159_584.png)

![ScreenShot_2026-06-28_140124_041](./assets/ScreenShot_2026-06-28_140124_041.png)
...
![ScreenShot_2026-06-28_140332_310](./assets/ScreenShot_2026-06-28_140332_310.png)
...
![ScreenShot_2026-06-28_140540_088](./assets/ScreenShot_2026-06-28_140540_088.png)

在弹出的菜单中选择刚创建的工件 → `Build`

![ScreenShot_2026-06-28_140621_813](./assets/ScreenShot_2026-06-28_140621_813.png)

等待构建完成，输出目录在 `out/artifacts/YourProject_jar/` 下

![ScreenShot_2026-06-28_140652_847](./assets/ScreenShot_2026-06-28_140652_847.png)
...
![be8a80f6623757eca09433dd4a13e255](./assets/be8a80f6623757eca09433dd4a13e255.png)
...
![ScreenShot_2026-06-28_143721_091](./assets/ScreenShot_2026-06-28_143721_091.png)

安装就是一路 Next。首次打开会提示输入 License key，没有的话可以用试用版（功能完整，生成的 exe 会弹试用提示框）。或者另外在网上搜一个激活码，名字和公司随便写，License key随便搜一下都能用。

> exe4j 6.0 及以上版本需要 JDK 1.8 及以上。

![ScreenShot_2026-06-28_144900_814](./assets/ScreenShot_2026-06-28_144900_814.png)
...
![在这里插入图片描述](./assets/a74d2b1b771a59c166e29fe22f202554.png)



### 5.2 命名输出(Application Info)

![e6b4fb21523266a7e9e3d540f8f452e0](./assets/e6b4fb21523266a7e9e3d540f8f452e0.png)



![ScreenShot_2026-06-28_153818_727](./assets/ScreenShot_2026-06-28_153818_727.png)
...
![d554cd12beb59aa2219d89349e0befb7](./assets/d554cd12beb59aa2219d89349e0befb7.png)

这里可以设置自动保存错误日志，可以设置以覆写的方式保存，还是追加的方式保存日志。插件会自动检测你`try - catch` 语句中的`println`语句，然后保存到文件中。

![ScreenShot_2026-06-28_161210_836](./assets/ScreenShot_2026-06-28_161210_836.png)

![ScreenShot_2026-06-28_160821_093](./assets/ScreenShot_2026-06-28_160821_093.png)



![b2c05d5f952eddc55fcf1025c9e40128](./assets/b2c05d5f952eddc55fcf1025c9e40128.png)



### 5.4 添加 JAR & 指定主类

![a10eacf414e5b8b628a82b33a8f7c2f8](./assets/a10eacf414e5b8b628a82b33a8f7c2f8.png)

> 选择带第三方依赖的jar包进行加载

![4e0b021c61d5b5a171290042a50132e3](./assets/4e0b021c61d5b5a171290042a50132e3.png)

> 选择对应的jar

![6210e8942b92ffd60707a12815818a71](./assets/6210e8942b92ffd60707a12815818a71.png)

> 选择主函数所在启动类

![f9d39be7f9247aa61be4e3b9679f550e](./assets/f9d39be7f9247aa61be4e3b9679f550e.png)

### 5.5 设置 JRE

![9c2943f0e8042ccf955a2828f73f2b4e](./assets/9c2943f0e8042ccf955a2828f73f2b4e.png)
...
![4947110fd4474b19ce87217ff09d26d1](./assets/4947110fd4474b19ce87217ff09d26d1.png)



![c76cb8f4506eb4f253233d9ec27ff506-1782633128099-25](./assets/c76cb8f4506eb4f253233d9ec27ff506-1782633128099-25.png)

![a7bbccaf7e47e393eba5070e39b024eb](./assets/a7bbccaf7e47e393eba5070e39b024eb.png)

![ScreenShot_2026-06-28_155449_401](./assets/ScreenShot_2026-06-28_155449_401.png)
...
![ScreenShot_2026-06-28_155727_866](./assets/ScreenShot_2026-06-28_155727_866.png)
...
![a634b9655d13d6c0a4277538efdeebba](./assets/a634b9655d13d6c0a4277538efdeebba.png)

![1878a72b97638ba7036cdc05d60d9ff7](./assets/1878a72b97638ba7036cdc05d60d9ff7.png)
...
> 添加代码之后会`生成两个jar包`，注意使用工具加载时的选择。
 ...
 ![在这里插入图片描述](./assets/6210e8942b92ffd60707a12815818a71-1782635075769-34.png)
